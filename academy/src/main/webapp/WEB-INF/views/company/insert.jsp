...
<form action="" method="post" enctype="multipart/form-data" autocomplete="off">
    <div class="container w-800">
        <div class="cell" style="margin: 10px; padding: 10px">
     	   <div class="cell">
          	  <h2><i class="fa-solid fa-building green"></i>&nbsp;신규 기업 등록</h2>
            </div>
            <hr>
            <div class="cell">      
                <div class="cell">
                ...
                <div class="cell">
                    <h3>상호명</h3>
                    <input type="text" name="companyName" class="field" size="30" style="border-radius: 10px;">
                </div>

				<div class="cell">
				    <h3>업체 연락처&nbsp;<label style="color: grey; font-size: 13px; font-weight: 500;">(* 담당자 연락처)</label></h3>
				    <input type="text" name="companyContact" class="field" size="20" style="border-radius: 10px;">
				</div>

				<div class="cell">
				    <h3>기업 홈페이지 URL</h3>
				    <input type="text" name="companyURL" class="field" size="50" style="border-radius: 10px;">
				</div>								

                <div class="cell">
                    <h3>사업자 등록번호</h3>
                    <input type="text" name="companyCrNumber" class="field" maxlength="12" oninput="inputCrNum(this)" style="border-radius: 10px;">
                </div>

                <div class="cell">
                    <h3>산업군 및 직종</h3>
                    <select id="firstSelect" onchange="updateSecondSelect()" class="selectBox field" name="companyIndustry" style="width: 200px; border-radius: 10px;">
                    ...
                    <select id="secondSelect" class="selectBox field" name="companyJob" style="border-radius: 10px; width: 200px;">
                ...
                <div class="cell">
                    <h3>기업 주소</h3>
                    <div class="cell left">
                        <input type="text" name="companyPost" size="14" maxlength="6" class="field" placeholder="우편번호" style="border-radius: 10px;">
                    ...
                    <div class="cell">
                        <input type="text" name="companyAddress1" class="field w-100" placeholder="기본주소" style="border-radius: 10px;">
                    </div>
                    <div class="cell">
